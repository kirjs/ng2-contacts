...
var Monkey = (function () {
  ...
  Monkey.prototype.update = function update() {
    ...
    if (this.tree.options.lazyMonkeys) this.tree._data = _update3['default'](this.tree._data, this.path, { type: 'monkey', value: lazyGetter }, this.tree.options).data;else this.tree._data = _update3['default'](this.tree._data, this.path, { type: 'set', value: lazyGetter() }, this.tree.options).data;
